...
public class ContatoDao {
	...
	public void adicionar(Contato contado) {
		String sql = "INSERT INTO contatos_samuel" + " (nome,email,endereco,dataNascimento)" + " VALUES (?,?,?,?)";
		try {

			PreparedStatement stmt = conection.prepareStatement(sql);
			stmt.setString(1, contado.getNome());
			stmt.setString(2, contado.getEmail());
			stmt.setString(3, contado.getEndereco());
			stmt.setDate(4, new Date(contado.getDataNascimento().getTimeInMillis()));
			 ...
			 * finally { try { conection.close(); System.out.println("conexao fechada"); }
			 * catch (SQLException e) { throw new
			 * RuntimeException("Falha ao fechar conexao"); } }
			 */
	}
