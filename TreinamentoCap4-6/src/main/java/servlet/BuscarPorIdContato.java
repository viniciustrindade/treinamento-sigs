...
@WebServlet("/BuscarPorIdContato")

public class BuscarPorIdContato extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		out.println("Data de nascimento: " + formatarData.format(contato.getDataNascimento().getTime()) + "<br/> <br/>");
