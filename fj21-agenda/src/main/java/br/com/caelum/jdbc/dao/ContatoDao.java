...
public class ContatoDao {
	...
	public void adiciona(Contato contato) {
		...
		try {
			...
			stmt.setDate(4, contato.getDataNascimento() == null ? null : new Date(contato.getDataNascimento().getTimeInMillis()));
	...
	public Contato pesquisar(int id) {
		...
		try {
			...
			// prepared statement para consulta por id
	...
	public List<Contato> getLista(String pesquisa) {
		...
		try {
			...
			if (pesquisa.equals("")) {
				...
				stmt = this.connection.prepareStatement("select * from contatos where nome like ?");
